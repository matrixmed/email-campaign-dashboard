...
const MetricsTable = ({ currentRows, processedFullData, selectedColumn, handleColumnChange, currentPage, rowsPerPage, handlePagination, availableMetrics, totalPages, handleRowsPerPageChange, selectedDeployment, handleDeploymentChange }) => {
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            const isInMetricDropdown = metricDropdownRef.current && metricDropdownRef.current.contains(event.target);
            if (!event.target.closest('th') && !isInMetricDropdown) {
                ...
                >
                    {availableMetrics.map((metric, index) => (
                        <div
                            ...
                            onClick={(e) => {
                                e.stopPropagation();
                                handleColumnChange(activeDropdown, metric);
                                setActiveDropdown(null);
                            }}

    ...
    return (
        <div className="list-analysis-container">
            <div className="analysis-content">
                <div className="iqvia-content-toolbar">
                    <button className="section-header-clear-btn" onClick={clearAnalysis}>Clear Analysis</button>
                </div>
                {error && (
